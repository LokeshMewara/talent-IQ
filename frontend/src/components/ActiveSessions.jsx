        ...
        <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2">
          {isLoading ? (
                  ...
                  <div className="flex items-center justify-between gap-4 p-5">
                    ...
                    <div className="flex items-center gap-4 flex-1">
                      <div className="relative size-14 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center">
                        ...
                        <div className="absolute -top-1 -right-1 size-4 bg-success rounded-full border-base-100"/> 
                      </div>
            ...
            <div className="text-center py-16">
              ...
              <p className="text-lg font-semibold opacity-70 mb-1">No active session</p>
