...
export const useCreateSession = () => {
   const result = useMutation({
    ...
    onError:(error) => toast.success(error.response?.data?.message || "Failed to create room"),
   })
...
export const useJoinSession = (id) => {
    const result = useMutation({
        ...
        onSuccess:() => toast.success("Joined session successflly!"),
...
export const useEndSession = (id) => {
    const result = useMutation({
        ...
        onSuccess:() => toast.success("Session ended successflly!"),
        onError: () => toast.error(error.response?.data?.message || "Failed to join session"),
    });
